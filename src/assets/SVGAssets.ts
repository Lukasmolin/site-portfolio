...
export default abstract class SVGAssets {
    ...
    public static readonly typescript = TypescriptLogo;
    public static readonly javascript = JavascriptLogo;
    public static readonly html5 = HTML5Logo
    ...
    public static readonly spring = SpringFrameworkLogo
    public static readonly springBoot = SpringBootLogo;
    public static readonly springSecurity = SpringSecurityLogo;
    public static readonly hibernateJpa = HibernateJPALogo;
    public static readonly junit = Junit5Logo;
    ...
    public static readonly database = DatabaseIcon;
}